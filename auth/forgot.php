...
<form class="login-form" action="../auth/send-reset.php" method="POST">
    <div class="user-type-selection" style="margin-bottom: 20px;">
        <label class="radio-container">
            <input type="radio" name="user_type" value="nakes" required>
            <span class="custom-radio"></span> Tenaga Kesehatan
        </label>
        <label class="radio-container">
            <input type="radio" name="user_type" value="ibu_muda" required>
            <span class="custom-radio"></span> Ibu Muda
        </label>
    </div>
