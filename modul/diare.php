...
<body>
    ...
    <h2>Pencegahan dan Penanganan Diare pada Anak untuk Kesehatan Optimal</h2>
    <br>
    <br>
    <div class="rounded-image-container">
    <img src="../assets/images/diare.webp" alt="Rounded Image" class="rounded-image">
    <br>
    <div class="article-content">
    <p>Diare adalah kondisi yang umum terjadi pada anak-anak, terutama pada usia dini. Penyakit ini ditandai dengan frekuensi buang air besar yang meningkat dan tinja yang lebih cair dari biasanya. Meskipun biasanya tidak berbahaya, diare bisa menyebabkan dehidrasi dan komplikasi serius jika tidak ditangani dengan baik.</p>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    
    <div class="sub-title">Penyebab Diare pada Anak</div>
    <p>Diare pada anak dapat disebabkan oleh berbagai faktor, seperti:</p>
    <hr style="border: none; height: 10px; background-color: transparent;" />
    <ul class="content-list">
        <li>Infeksi virus (seperti rotavirus atau norovirus)</li>
        <li>Infeksi bakteri (seperti Salmonella atau Escherichia coli)</li>
        <li>Penyakit parasit</li>
        <li>Alergi makanan atau intoleransi laktosa</li>
        <li>Penggunaan antibiotik yang mengganggu keseimbangan bakteri usus</li>
    </ul>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    
    <div class="sub-title">Cara Menangani Diare pada Anak</div>
    <p>Untuk menangani diare pada anak, orangtua dapat mengikuti langkah-langkah berikut:</p>
    <hr style="border: none; height: 10px; background-color: transparent;" />
    <ul class="content-list">
        <li>Pastikan anak tetap terhidrasi dengan memberikan cairan seperti air, oralit, atau ASI.</li>
        <li>Jika anak sudah mulai makan makanan padat, berikan makanan yang mudah dicerna, seperti nasi, pisang, atau roti panggang.</li>
        <li>Hindari memberikan minuman manis atau jus yang dapat memperburuk dehidrasi.</li>
        <li>Jika diare berlangsung lebih dari 24 jam atau disertai gejala berat, segera konsultasikan dengan dokter.</li>
    </ul>
</div>
