...
<body>
    ...
    <h2>Peran Imunisasi dalam Meningkatkan Kesehatan dan Tumbuh Kembang Anak</h2>
    <br>
    <br>
    <div class="rounded-image-container">
    <img src="../assets/images/imunisasi.webp" alt="Rounded Image" class="rounded-image">
    <br>
    <div class="article-content">
    <p>Imunisasi adalah salah satu langkah penting dalam menjaga kesehatan anak. Dengan memberikan vaksinasi, orangtua membantu melindungi anak dari berbagai penyakit yang dapat mengancam nyawa atau mengganggu tumbuh kembang anak. Vaksin bekerja dengan cara memperkenalkan tubuh pada patogen dalam bentuk yang aman, sehingga tubuh dapat membentuk kekebalan untuk melawan infeksi di masa depan.</p>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    
    <div class="sub-title">Mengapa Imunisasi Itu Penting?</div>
    <p>Imunisasi dapat mencegah penyakit-penyakit berbahaya seperti polio, campak, dan hepatitis. Selain itu, imunisasi juga penting untuk mencegah wabah penyakit yang bisa terjadi jika tingkat kekebalan dalam masyarakat menurun. Dengan melindungi anak dari penyakit, imunisasi berkontribusi pada pertumbuhan dan perkembangan yang optimal, baik fisik maupun mental.</p>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    
    <div class="sub-title">Jenis-jenis Imunisasi yang Dibutuhkan Anak</div>
    <p>Beberapa imunisasi yang umum diberikan pada anak-anak meliputi:</p>
    <hr style="border: none; height: 10px; background-color: transparent;" />
    <ul class="content-list">
        <li>Vaksin BCG untuk mencegah tuberkulosis</li>
        <li>Vaksin DPT untuk melindungi dari difteri, pertusis, dan tetanus</li>
        <li>Vaksin Polio untuk mencegah polio</li>
        <li>Vaksin Hepatitis B untuk mencegah hepatitis B</li>
        <li>Vaksin Campak, Rubella, dan Gondongan untuk mencegah tiga penyakit ini sekaligus</li>
    </ul>
</div>
