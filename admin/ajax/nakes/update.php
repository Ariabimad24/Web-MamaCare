...
if (isset($_POST['submit'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil diperbarui.'); window.location.href = 'admin/data-pengguna.php';</script>";
    } else {
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <a href="../admin/data-pengguna.php" class="btn btn-secondary">Cancel</a>
                            </td>
                        </tr>
                    </table>
                </div>
