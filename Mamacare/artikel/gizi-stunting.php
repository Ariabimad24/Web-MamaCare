...
<body>
    ...
    <h2>Asuhan Gizi pada Anak Stunting: Langkah Penting untuk Masa Depan yang Lebih Baik</h2>
    <br>
    <br>
    <div class="rounded-image-container">
    <img src="../assets/images/gizi.webp" alt="Rounded Image" class="rounded-image">
    <div class="article-content">
    <div class="sub-title">Apa Itu Stunting?</div>
    <p>Stunting adalah kondisi di mana anak mengalami pertumbuhan fisik yang terhambat akibat kekurangan gizi kronis, terutama selama 1.000 hari pertama kehidupan. Anak yang stunting memiliki tinggi badan di bawah rata-rata untuk usianya dan berisiko mengalami gangguan perkembangan kognitif, kesehatan, dan produktivitas di masa depan.</p>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    <div class="sub-title">Penyebab Stunting</div>
    
    <p class="content-text">Stunting biasanya disebabkan oleh kombinasi faktor, antara lain:</p>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    <ul class="content-list">
        <li>Asupan gizi yang tidak mencukupi selama masa kehamilan dan dua tahun pertama kehidupan anak.</li>
        <li>Pola makan yang kurang beragam dan rendah protein.</li>
        <li>Infeksi berulang yang mengganggu penyerapan nutrisi.</li>
        <li>Sanitasi dan kebersihan lingkungan yang buruk.</li>
    </ul>
    <div class="sub-title">Asuhan Gizi untuk Anak Stunting</div>
    <div class="content-numbered">
        <p><strong>1. Pemberian ASI Eksklusif:</strong> ASI eksklusif selama enam bulan pertama kehidupan adalah langkah penting untuk mencegah stunting. ASI mengandung semua nutrisi yang dibutuhkan bayi untuk tumbuh dan berkembang.</p>
        <p><strong>2. MPASI yang Berkualitas:</strong> Setelah usia enam bulan, anak memerlukan makanan pendamping ASI (MPASI) yang bergizi seimbang. MPASI harus mengandung protein, lemak sehat, vitamin, dan mineral. Contoh makanan bergizi adalah telur, ikan, daging ayam, kacang-kacangan, dan sayuran hijau.</p>
    </div>
    <div class="sub-title">Pentingnya Intervensi Dini</div>
    <p>Intervensi sejak dini sangat penting untuk mencegah stunting dan dampaknya pada masa depan anak. Pemerintah, tenaga kesehatan, dan masyarakat perlu bekerja sama untuk meningkatkan kesadaran akan pentingnya asupan gizi yang cukup.</p>
    <hr style="border: none; height: 5px; background-color: transparent;" />
    <div class="sub-title">Kesimpulan</div>
    <p>Asuhan gizi pada anak stunting bukan hanya tentang memperbaiki kondisi saat ini, tetapi juga memastikan mereka memiliki masa depan yang lebih sehat dan produktif. Dengan langkah yang tepat, anak-anak Indonesia dapat tumbuh optimal dan berkontribusi pada kemajuan bangsa.</p>
</div>
