...
$sql = "SELECT * FROM modul_kesehatan";
...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Modul Kesehatan</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Modul Kesehatan Terbaru</h3>
                </div>
                <div class="card-body p-0">
                    <table id="tableModul" class="table table-hover">
                        <thead>
                            <tr>
                                <th>Judul</th>
                                <th>Gambar</th>
                        ...
                        <tbody>
                        <?php
                        // Ambil data dari tabel modul_kesehatan
                        $sql = "SELECT * FROM modul_kesehatan";
                        $result = $conn->query($sql);
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                // Path gambar, gunakan default jika tidak ada gambar
                                $base_url = "http://localhost/Mamacare/";
                                ...
                                echo "<td class='align-middle'>" . htmlspecialchars(substr($row['highlight'], 0, 100)) . (strlen($row['highlight']) > 100 ? '...' : '') . "</td>";
                                echo "<td class='align-middle'>" . htmlspecialchars(substr($row['isi'], 0, 100)) . (strlen($row['isi']) > 100 ? '...' : '') . "</td>";

                                // Tombol Edit dan Delete
                                echo "<td class='align-middle text-center'>
                                        <div class='btn-group'>
                                            <a href='ajax/modul/update.php?id=" . $row['id'] . "' class='btn btn-sm btn-info'>
                                        <i class='fas fa-edit'></i>
                                    </a>
                                    <a href='ajax/modul/delete.php?id=" . $row['id'] . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus artikel ini?\")'>
                            ...
                            echo "<tr><td colspan='5' class='text-center'>Tidak ada modul kesehatan tersedia</td></tr>";
                        }
                        ?>
                        <tr>
                            <td colspan="4" class="text-center">Tambah Modul Baru</td>
                            <td class="align-middle text-center">
                                <a href="ajax/modul/add.php" class="btn btn-sm btn-success">
